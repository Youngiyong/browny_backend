...
export async function createUserFollow(event: any){
    ...
    try {
        ...
        follow.fk_user_id = payload.user_id
...
export async function deleteUserFollow(event: any){
    const connection = new Database();
    await connection.getConnection();
